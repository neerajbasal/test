...
public class calendars extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.getcalendarlayout);
 ...
 /*   private void addEvent()
    ...
    private void getLastThreeEvents()
    {
		...
		if(m_selectedCalendarId.equals("1"))
		{
			Intent intent = new Intent(calendars.this,calpage.class);
		...
		else
		{
			...
			Intent intent = new Intent(calendars.this,tempclass.class);
			intent.putExtra("title", title);	
			intent.putExtra("begin", dates);
			startActivity(intent);
		}
    ...
    {
    	Date date = new Date(Long.parseLong(p_time_in_millis));
